    ...
    return (
        <div className="mx-10 ">
            ...
            <div className="flex justify-center mt-2 font-sans">
                    <p className="text-2xl text-center mx-10 mt-2 w-1/2 min-w-96 py-10 border-t-4 border-b-4 border-blue-300">This is a paragraph about me.I am a college student in my 3rd year studying a Bachelor's Degree in Informatics in Economy</p>
            </div>
        </div>
    )
}
